...
class TestAddContact(unittest.TestCase):
    ...
    def test_TestAddContact(self):
        ...
        wd.find_element_by_name("lastname").send_keys("ContactLastName")
        wd.find_element_by_name("nickname").click()
        wd.find_element_by_name("nickname").clear()
        wd.find_element_by_name("nickname").send_keys("Contact1")
        wd.find_element_by_name("title").click()
        wd.find_element_by_name("title").clear()
        wd.find_element_by_name("title").send_keys("ContactTitle")
        wd.find_element_by_name("company").click()
        wd.find_element_by_name("company").clear()
        wd.find_element_by_name("company").send_keys("NewCompany")
