...
class TestAddContact(unittest.TestCase):
    ...
    def test_TestAddContact(self):
        ...
        self.add_new_contact(wd, Contact(firstname="ContactName", lastname="ContactLastName", nickname="Contact1",
    ...
    def test_TestAddEmptyContact(self):
        wd = self.wd
        self.open_home_page(wd)
        self.login(wd, username="admin", password="secret")
        self.add_new_contact(wd, Contact(firstname="", lastname="", nickname="",
